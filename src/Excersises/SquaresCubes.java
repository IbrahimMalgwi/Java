// Question 2.31 An application for Table of dietelChapter2.Square and Cubes

public class SquaresCubes {
	public static void main(String[] args) {
		int number0 = 0;

		System.out.println("Number	dietelChapter2.Square 	Cube");
		...
		System.out.printf("%d	%d	%d%n", 8, (9 * 9), (9 * 9 * 9));
