/* question 2.15 application that asks the user to enter two integers, 
...
public class Square {
	public static void main(String[] args) {
		...
		System.out.printf("Square of Num 1 is %d%nSquare of num 2 is %d%nSum of Square is %d%nDifference of square is %d%n", squareNum1,squareNum2,sumSquare,difSquare);
