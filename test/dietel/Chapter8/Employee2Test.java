...
import dietel.Chapter8.Employee2;
...
class Employee2Test {
    public static void main(String[] args) {
        ...
        Employee2 e1 = new Employee2("Sussan", "Baker");
        Employee2 e2 = new Employee2("Bob", "Blue");


        // show that count is 2 after creating two Employees
        System.out.printf("%nEmployees after instantiation:%n");
        System.out.printf("via e1.getCount(): %d%n", e1.getClass() );
        System.out.printf("via e2.getCount(): %d%n", e2.getClass() );
